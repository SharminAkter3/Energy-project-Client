...
import blog1 from '../../../assets/Images/dashboard/5092388c2eefa6ba6841a6fe5db95524.jpeg'
        ...
        {/* side bar one */}
            ...
            <div className="bg-[#FEFEFE] p-5 mr-5 col-span-2">
                ...
                <div className='text-center'>
                    <div className='w-full flex justify-center mb-2'><img style={{ height: '100px', width: '100px', color: 'white', borderRadius: '50%' }} src={blog1} alt="" /></div>

                    <h1 className='text-2xl font-bold'>How to calculate energy usage?</h1>
                    <p>Lorem ipsum dolor sit amet consectetur. Augue mi dui massa hendrerit ultrices quisque.</p>
                ...
                <div className='mt-4'>
                    ...
                    <p><span className='text-[#64748B] font-bold'>Total view </span>: 248</p>
                ...
                <div>
                    ...
                    <div className='grid grid-cols-3 gap-5 mt-5 items-center'>
                        <div className='flex justify-center'>
                            <img className="circular-img" style={{ height: '50px', width: '50px', color: 'white', borderRadius: '50%' }} src={blog1} alt="" />
                        </div>
