    ...
    return (
        <div className='container my-52'>
            ...
            <div className='chose-card-container'>
                ...
                <div className='chose-card'>
                    <div className='chose-content'>
                        <h1 className='h1-text'>Competitive pricing</h1>
                        <div className='mb-20'>
                            <p className='p-text'>We understand the need to maintain expenses within <br />your grasp. That’s why we provide competitive pricing  <br /> to guarantee you save money without <br />compromising on quality and  <br />dependability. Switching with us is also easy, taking  <br /> the stress out of changing to a cheaper deal. </p>
                        </div>
                    </div>
                    <div>
                        <img className='chose-image'
                ...
                <div className='chose-card'>
                    ...
                    <div className='chose-content'>
                        <h1 className='h1-text'>Exceptional Customer Support</h1>
                        <div className='mb-20'>
                            <p className='p-text'>At Energy Solutions we believe in putting our <br /> customers first. Our team of knowledgeable <br />professionals is always available to address any <br /> questions or concerns you may have. Whether you <br /> need assistance with billing inquiries or technical <br /> support, we’re here to help every step of the way.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='chose-card'>
                    <div className='chose-content'>
                        <h1 className='h1-text'>Sustainable Solutions</h1>
                        <div className='mb-20'>
                            <p className='p-text'>We are committed to sustainability and <br /> environmental responsibility. That’s why we offer <br /> renewable energy options to help reduce your carbon <br /> footprint and contribute to a cleaner, greener future. </p>
                        </div>
                    </div>
                    <div>
                        <img className='chose-image'
